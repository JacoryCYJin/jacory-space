...
The frontend is Vue 3 + Vite under `jacory-space-frontend/`, and the project already has a Three.js surface in `src/components/tools/layered-spatial-index/`. When adding or editing Three.js in this project:
...
- After frontend 3D changes, run `cd jacory-space-frontend && npm run build`. If visual behavior changed, verify desktop and mobile framing in the browser.
