<template>
  <div>
    <pre
      :id="contentId"
      class="border border-line bg-card px-5 py-6 font-mono text-sm leading-7 text-foreground md:px-7 md:py-8"
      :class="expanded ? 'overflow-x-auto' : 'h-96 overflow-x-auto overflow-y-auto'"
