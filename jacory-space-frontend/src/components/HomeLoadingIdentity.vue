  ...
  loaderMedia.add(
    ...
    (context) => {
      ...
      introTimeline
        ...
        .to(iLeft, { x: -145.201, duration: 0.78, ease: 'power3.inOut' }, 'iSplit')
        .to(iRight, { x: 145.201, duration: 0.78, ease: 'power3.inOut' }, 'iSplit')
        .addLabel('mIn', 'iSplit')
        ...
        .to(iLeft, { x: -795.598, duration: 0.82, ease: 'power3.inOut' }, 'mSplit')
        .to(iRight, { x: 795.598, duration: 0.82, ease: 'power3.inOut' }, 'mSplit')
        .to(mLeft, { x: -650.398, duration: 0.82, ease: 'power3.inOut' }, 'mSplit')
        .to(mRight, { x: 650.398, duration: 0.82, ease: 'power3.inOut' }, 'mSplit')
