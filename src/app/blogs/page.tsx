...
const BlogPage = () => {
  ...
  // 获取所有分类
  const allCategories = ['全部', ...new Set(articles.flatMap(article => article.categories))];
  
  return (
    <div className="blog-container">
      <section className="blog-header">
        <h1 className="blog-title">闲笔偶记</h1>
        <p className="blog-description">记录思考与感悟，分享技术与生活</p>
      </section>
